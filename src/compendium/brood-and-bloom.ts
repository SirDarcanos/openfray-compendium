...
export const broodAndBloomCreatures: Creature[] = [
  ...
  },
  {
    ...
    "type": "aberration",
    "alignment": "unaligned",
    "description": "A weeping grey-green sac that rides a strong or hardy host through swamp and floodplain, drinking off its vigor. It is what a latchling becomes on a body whose strength was the best thing on offer, and the first rung of the sallow line. Fed long enough, it deepens into a sallow fluke.",
    "ac": 12,
    "maxHp": 10,
    "hpFormula": "4d4",
    "speed": {
  ...
  },
  {
    ...
    "type": "monstrosity",
    "alignment": "unaligned",
    "description": "A wading bird the height of a horse, grey-white and long-necked, standing motionless in the shallows for hours. Lancebills eat parasites and nothing else. They can tell an infected creature from a clean one at a hundred paces, and they take what they came for through whatever is in the way.",
    "ac": 15,
    "maxHp": 168,
    "hpFormula": "16d10+80",
    "speed": {
  ...
  },
  {
    ...
    "description": "Knee-high and already grey. Orcshrooms are born colonized, not infected — the ribbing is present at birth, the crest comes in with the teeth. Whelps run messages for the warband, and they are not kept out of a fight so much as positioned inside one.",
    "ac": 13,
    "maxHp": 60,
    "hpFormula": "11d6+22",
    "speed": {
  ...
  },
  {
    ...
    "type": "humanoid",
    "alignment": "neutral evil",
    "description": "Not yet an orcshroom, and no longer whoever it was. The grey climbs the throat, the cough produces dust, and the victim slowly loses interest in everything except being somewhere else. A spore-struck can be of any species, and is most often whoever the tribe took last.",
    "ac": 12,
    "maxHp": 71,
    "hpFormula": "11d8+22",
    "speed": {
  ...
  },
  {
    ...
    "type": "plant (orc)",
    "alignment": "chaotic evil",
    "description": "Leaner than the warriors and grown low, the crest flattened back along the skull and the gill-ribbing reduced to a fine grey stipple. Stalkers range days ahead of the warband. They do not track by sight or scent but by the spores the tribe has already put into the world.",
    "ac": 14,
    "maxHp": 91,
    "hpFormula": "14d8+28",
    "speed": {
  ...
  },
  {
    ...
    "type": "plant (orc)",
    "alignment": "chaotic evil",
    "description": "A head taller than a living orc, and grey where an orc is green. Pale ribbing climbs the throat and splits into a low crest across the skull, and the whole body sheds a fine dust that hangs in still air. It carries a spear it made itself, and it argues with its warband in Orc while it fights.",
    "ac": 15,
    "maxHp": 97,
    "hpFormula": "13d8+39",
    "speed": {
  ...
  },
  {
    ...
    "type": "plant (orc)",
    "alignment": "chaotic evil",
    "description": "The growth has stopped pretending to be an orc. Grey shelf-fungus stands out from the shoulders and back in overlapping tiers, and the head sits low between them. The chieftain is the oldest walking thing in the tribe, and the only one the colony speaks through directly.",
    "ac": 16,
    "maxHp": 152,
    "hpFormula": "16d8+80",
    "speed": {
  ...
  },
  {
    ...
    "type": "plant",
    "alignment": "unaligned",
    "description": "A grey-white rind across the underside of burned ground, thin as a fingernail and as hard. It grows in the cavities a fire leaves and is seen only after somebody has put a foot through the layer above it.",
    "ac": 12,
    "maxHp": 60,
    "hpFormula": "11d8+11",
    "speed": {
  ...
  },
  {
    ...
    "type": "plant",
    "alignment": "unaligned",
    "description": "The ashcap fruiting body, hung rather than standing: a grey pod the size of a barrel, grown from a wall or beam on a stalk long enough to swing. It swings — slowly, without wind, to a rhythm that has nothing to do with anything nearby. What comes out when it opens is warm.",
    "ac": 14,
    "maxHp": 123,
    "hpFormula": "13d10+52",
    "speed": {
  ...
  },
  {
    ...
    "type": "plant",
    "alignment": "neutral evil",
    "description": "What Calcination leaves standing. The body is intact and weighs almost nothing, grey through to the bone, with no water left anywhere in it — no voice, no tears, nothing to bleed. It moves like somebody with an errand and makes no sound at all.",
    "ac": 15,
    "maxHp": 152,
    "hpFormula": "16d8+80",
    "speed": {
  ...
  },
  {
    ...
    "type": "plant",
    "alignment": "unaligned",
    "description": "A grey-brown skin across worked stone, following the mortar lines like frost on a window. It grows in cellars and undercrofts and the shaded faces of standing walls, and it passes for water damage until somebody puts a hand on it.",
    "ac": 15,
    "maxHp": 71,
    "hpFormula": "11d8+22",
    "speed": {
  ...
  },
  {
    ...
    "type": "monstrosity",
    "alignment": "unaligned",
    "description": "In a rich larder — a plague pit, a sealed barrow, a battlefield ploughed under — the grubs of several corpses meet, and rather than compete they fuse under a shared coat of their own wax. The mass moves like slow porridge and eats like a tide.",
    "ac": 12,
    "maxHp": 68,
    "hpFormula": "8d10+24",
    "speed": {
